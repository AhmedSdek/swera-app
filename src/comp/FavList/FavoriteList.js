                ...
                <Container >
                    <Stack >
                        ...
                        {localFilter.length > 0 ?
                            <Stack sx={{ flexDirection: 'row', flexWrap: 'wrap', gap: 1, paddingTop: '10px' }}>
                                {value.docs.filter((itm) => localFilter.includes(itm.data().id)
                                ).map((item, index) => {
                                    return (
                                        <Stack sx={{ marginBottom: '15px', position: 'relative', maxHeight: '100%', width: { lg: '32%', md: '49%', xs: '100%' } }} key={index}>
                            ...
                            :
                            <Stack sx={{ height: '458px', justifyContent: 'center', alignItems: 'center' }}>
                                <Typography>
                                    No Results To Show
                                </Typography>
                            </Stack>
