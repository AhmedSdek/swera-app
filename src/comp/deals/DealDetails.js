            ...
            <Box sx={{ marginTop: '40px', padding: '15px 0', position: 'relative' }}>
                ...
                <Container>
                            ...
                            <Stack sx={{ flexDirection: 'column', gap: 1 }}>
                                ...
                                <Stack sx={{ flexDirection: 'row', gap: 2 }}>
                                    <Stack>
                                        <Button onClick={() => {
                                            setOpen(true)
                                        }} sx={{ width: '150px', borderColor: 'black', padding: '5px' }} variant='outlined' >
                    ...
                    <Card sx={{
                        ...
                        <img style={{ width: '100%', maxHeight: '100%' }} src={value.data().Masterimg[0]} alt='' />
                        <IconButton onClick={() => {
                            setOpen(false)
                    ...
                    <Card sx={{
                        ...
                        <img style={{ width: '100%', maxHeight: '100%' }} src={value.data().Layoutimg[0]} alt='' />
                        <IconButton onClick={() => {
                            setOpenLay(false)
                        }} sx={{ position: 'absolute', right: '25px', top: "55px", }}>
                            <Close sx={{ color: 'red' }} />
